...
(
 ...
 double*     restrict c
  ...
  double* c0, *c1, *c2;
  c0 = c;  c1 = c + 16, c2 = c + 32;

  ymm15 = _mm256_load_pd(c0+0);      ymm14 = _mm256_load_pd(c0+ 4);
  ymm0 = _mm256_add_pd(ymm0, ymm15);  ymm1 = _mm256_add_pd(ymm1, ymm14);
  _mm256_store_pd(c0+0, ymm0);       _mm256_store_pd(c0+4, ymm1);

  ymm15 = _mm256_load_pd(c0+8);      ymm14 = _mm256_load_pd(c0+ 12);
  ymm2 = _mm256_add_pd(ymm2, ymm15); ymm3 = _mm256_add_pd(ymm3, ymm14);
  _mm256_store_pd(c0+8, ymm2);       _mm256_store_pd(c0+12, ymm3);

  ymm15 = _mm256_load_pd(c1+0);      ymm14 = _mm256_load_pd(c1 + 4);
  ymm4 = _mm256_add_pd(ymm4, ymm15); ymm5 = _mm256_add_pd(ymm5, ymm14);
  _mm256_store_pd(c1+0, ymm4);       _mm256_store_pd(c1+4, ymm5);

  ymm15 = _mm256_load_pd(c1+8);      ymm14 = _mm256_load_pd(c1+ 12);
  ymm6 = _mm256_add_pd(ymm6, ymm15); ymm7 = _mm256_add_pd(ymm7, ymm14);
  _mm256_store_pd(c1+8, ymm6);       _mm256_store_pd(c1+12, ymm7);


  ymm15 = _mm256_load_pd(c2+0);      ymm14 = _mm256_load_pd(c2 + 4);
  ymm8 = _mm256_add_pd(ymm8, ymm15); ymm9 = _mm256_add_pd(ymm9, ymm14);
  _mm256_store_pd(c2+0, ymm8);       _mm256_store_pd(c2+4, ymm9);

  ymm15 = _mm256_load_pd(c2+8);        ymm14 = _mm256_load_pd(c2 + 12);
  ymm10 = _mm256_add_pd(ymm10, ymm15); ymm11 = _mm256_add_pd(ymm11, ymm14);
  _mm256_store_pd(c2+8, ymm10);        _mm256_store_pd(c2+12, ymm11);
 }
